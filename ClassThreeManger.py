...
class manage_class():
    ...
    def check_filtering_method(self, filter_value, filter_value_detail, categories):
    ...
    def filtering_for_color_size(self, _catvalue, _color_or_size="", _val="color", _min_price="0", _max_price="1",
